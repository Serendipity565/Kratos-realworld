...
const OperationRealWorldFavouriteArticle = "/realworld.v1.RealWorld/FavouriteArticle"
...
const OperationRealWorldUnFavouriteArticle = "/realworld.v1.RealWorld/UnFavouriteArticle"
...
func RegisterRealWorldHTTPServer(s *http.Server, srv RealWorldHTTPServer) {
	...
	r.POST("/api/articles/{slug}/favorite", _RealWorld_FavouriteArticle0_HTTP_Handler(srv))
	r.DELETE("/api/articles/{slug}/favorite", _RealWorld_UnFavouriteArticle0_HTTP_Handler(srv))
...
func _RealWorld_FavouriteArticle0_HTTP_Handler(srv RealWorldHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationRealWorldFavouriteArticle)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _RealWorld_UnFavouriteArticle0_HTTP_Handler(srv RealWorldHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationRealWorldUnFavouriteArticle)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *RealWorldHTTPClientImpl) FavouriteArticle(ctx context.Context, in *FavouriteArticleRequest, opts ...http.CallOption) (*SingleArticleReply, error) {
	...
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationRealWorldFavouriteArticle))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *RealWorldHTTPClientImpl) UnFavouriteArticle(ctx context.Context, in *UnFavouriteArticleRequest, opts ...http.CallOption) (*SingleArticleReply, error) {
	...
	pattern := "/api/articles/{slug}/favorite"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationRealWorldUnFavouriteArticle))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "DELETE", path, nil, &out, opts...)
	if err != nil {
		return nil, err
